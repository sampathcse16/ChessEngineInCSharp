...
namespace ChessEngine.Pieces
{
    public class Queen
    {
        ...
        public static List<Move> GetQueenMovesFromMagicBitboards(int square, ulong bishopMask, ulong occupancy, ulong ownBlockers)
        {
            ulong bishopBlockers = bishopMask & occupancy;
            ulong movesInBinary = QueenMovesHelper.QueenBlockerMovesToBinaryMoves[square, (int)((bishopBlockers * QueenMovesHelper.MagicNumbersForQueen[square]) >> (50))] & ~ownBlockers;
            return QueenMovesHelper.QueenMovesBinaryToActualMoves[(int)(movesInBinary % QueenMovesHelper.HashKeyForQueenMoves)];
        }
